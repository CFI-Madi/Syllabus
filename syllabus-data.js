...
GL9:{id:'GL9',type:'ground',stage:2,title:'Navigation: Charts, Publications, and Flight Computers',hrs:3.0,
  ...
  debrief:['True course 135°, variation 14°E, deviation −2°. What is compass heading?','WCA is 8° right, wind from 270° at 20 kt, heading 045°. Does this make sense?','You\'re planning KJQF to KFAY. The sectional shows a dashed magenta circle around the destination. What does that symbol mean, and what do you need to confirm before entering?','Your E6-B gives a groundspeed of 88 kt for a 52 NM leg. How long is that leg, and if you depart at 1345Z what is your ETA?'],
  scenario:null,
  whatIf:[
...
GL10:{id:'GL10',type:'ground',stage:2,title:'Navigation Systems',hrs:2.5,
  ...
  debrief:['CDI deflects full right, TO indication — which way do you turn to intercept?','How do you determine if you\'re on the correct radial vs. the reciprocal?','Your GPS annunciates RAIM unavailable 30 minutes into a VFR flight. What does RAIM mean, what likely caused it, and can you continue using GPS for navigation?','You do a VOR ground checkpoint at KJQF. The checkpoint calls for 345°, your OBS centers at 341°. Is this within limits, and what regulation governs VOR accuracy?'],
  scenario:null,
  whatIf:[
...
FL21:{id:'FL21',type:'flight',stage:2,title:'Maneuvers Review',
  ...
  errors:[],
  debrief:['Based on today, rank your top 3 areas to improve before Stage 2 check.','You\'re on short final at 200 ft AGL, clearly too high and too fast to land on the numbers. What do you do, and what is the latest decision point for a go-around?','Walk me through a power-on stall from entry to full recovery — what are your hands doing at each phase, in order?'],
  tasks:[
