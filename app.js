...
const V={
  ...
  tabTasks(lid,s){
    ...
    ${hasS&&isFL?`<div class="alert alert-info" style="margin-top:4px">Stu = Student self-grade · CFI = Instructor grade · U/M/S/G/E (FITS grading). All subtasks checked → task auto-signs off.</div>`:''}`;
  },
...
const CHEROKEE_WB_PROFILE = {
  ...
  stations: [
    ...
    { id:'fuel', label:'Fuel (Avgas 6 lbs/gal)', arm:95.0, maxWeight:297.8, placeholder:'lbs - full = 216 (std), 297.8 (LR)' }
  ],
  forwardLimits: [
    [1200, 84.0],
    [1650, 84.0],
